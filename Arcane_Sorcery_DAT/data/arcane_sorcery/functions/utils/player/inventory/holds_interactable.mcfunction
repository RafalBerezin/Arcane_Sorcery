...
execute store success score #as_holds_interactable ASFlag run data modify storage test player.held.ArcaneSorcery set from entity @s SelectedItem.tag.ArcaneSorcery
