...
# Explode
execute as @e[type=!#arcane_sorcery:spell_ignore,tag=!AS.spell.caster,distance=..7,sort=nearest] at @s run function arcane_sorcery:effect/spell/infernal/fireball/marker/hit/3
